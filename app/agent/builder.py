...
response_format_guide = (
    ...
    "1. 도구 응답을 받아 사람이 읽기 쉬운 요약만 전달. 기술 필드(x, y, id 등) 제거.\n"
    "2. 사용자에게 보여줄 정보: `name`, `road_address`, `phone`, `category` 같은 사람이 이해할 수 있는 내용만 사용.\n"
    "3. 여러 장소 추천 시 형식 예시:\n"
    "   - 번호 매기기로 간결하게 표현 (예: 1. 장소명 - 주소 - 카테고리)\n"
    "   - 3-5개 이내로 요약하되, 도구가 더 많이 반환해도 핵심만 선택\n"
    "</Response Format Guide>\n"
)
